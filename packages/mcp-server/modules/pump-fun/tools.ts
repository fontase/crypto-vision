    ...
    async ({ mint }) => {
      try {
        ...
        const lines = [
          ...
          `- Similar tokens launched: ${odds.historicalComparison.similarTokensLaunched.toLocaleString()}`,
          `- Similar tokens graduated: ${odds.historicalComparison.similarTokensGraduated.toLocaleString()}`,
