...
registry.register("on-chain", onChainChain, {
  description:
    "Bitcoin and Ethereum on-chain data from Blockchain.info, Mempool.space, Etherscan",
});

// Social Metrics
registry.register("social-metrics", socialChain, {
  description:
    "Social intelligence from LunarCrush, Santiment, and CryptoPanic",
});
...
registry.register("gaming-data", gamingDataChain, {
  description:
    "Blockchain gaming data from DappRadar, PlayToEarn, and Footprint",
});

// Macro/TradFi Data
registry.register("macro-data", macroChain, {
  description:
    "Macro economic indicators from FRED, Alpha Vantage, and Twelve Data",
});
...
registry.register("depin-data", depinChain, {
  description:
    "DePIN ecosystem metrics from DePINscan — devices, revenue, growth",
});
...
registry.register("coinglass-liquidations", coinglassLiquidationsChain, {
  description:
    "Aggregated liquidation data from CoinGlass (long/short breakdowns)",
});
