...
Respond with JSON only.`;
    ...
    const response = await aiComplete(EVENT_CLASSIFICATION_PROMPT, userPrompt, { maxTokens: 1000, temperature: 0.2, jsonMode: true, title: 'Crypto News Event Classifier' }, true);
