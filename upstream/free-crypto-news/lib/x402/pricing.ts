...
export const API_PRICING = {
  ...
  "/api/v1/gas": "$0.001",
  "/api/v1/exchanges": "$0.002",
  "/api/v1/search": "$0.001",
  "/api/v1/ohlcv": "$0.002",
  "/api/v1/orderbook": "$0.003",
  "/api/v1/fear-greed": "$0.002",
  "/api/v1/stablecoins": "$0.002",

  // ---------------------------------------------------------------------------
  // News & Content
  // ---------------------------------------------------------------------------
  "/api/v1/news": "$0.001",
  "/api/v1/bitcoin": "$0.001",
  "/api/v1/breaking": "$0.001",
  "/api/v1/categories": "$0.001",
  "/api/v1/sources": "$0.001",
  "/api/v1/tags": "$0.001",
  "/api/v1/articles": "$0.002",
  "/api/v1/regulatory": "$0.003",
  "/api/v1/academic": "$0.003",

  // ---------------------------------------------------------------------------
  // AI-Powered
  // ---------------------------------------------------------------------------
  "/api/v1/sentiment": "$0.005",
  "/api/v1/narratives": "$0.005",
  "/api/v1/digest": "$0.005",
  "/api/v1/summarize": "$0.003",
  "/api/v1/ask": "$0.005",
  "/api/v1/forecast": "$0.005",
  "/api/v1/classify": "$0.002",
  "/api/v1/ai/research": "$0.01",
  "/api/v1/ai/explain": "$0.003",

  // ---------------------------------------------------------------------------
  // Trading & Signals
  // ---------------------------------------------------------------------------
  "/api/v1/derivatives": "$0.003",
  "/api/v1/arbitrage": "$0.003",
  "/api/v1/signals": "$0.005",
  "/api/v1/liquidations": "$0.003",
  "/api/v1/funding-rates": "$0.002",
  "/api/v1/options": "$0.003",
  "/api/v1/backtest": "$0.01",
  ...
  "/api/v1/defi": "$0.002",
  "/api/v1/dex": "$0.002",
  "/api/v1/bridges": "$0.002",
  "/api/v1/yields": "$0.002",
  "/api/v1/token-unlocks": "$0.002",

  // ---------------------------------------------------------------------------
  // On-Chain & Chain-Specific
  // ---------------------------------------------------------------------------
  "/api/v1/onchain": "$0.003",
  "/api/v1/whale-alerts": "$0.003",
  "/api/v1/solana": "$0.002",
  "/api/v1/l2": "$0.002",
  "/api/v1/nft": "$0.003",
  "/api/v1/fundamentals": "$0.003",

  // ---------------------------------------------------------------------------
  // Social Intelligence
  // ---------------------------------------------------------------------------
  "/api/v1/social": "$0.003",
  "/api/v1/influencers": "$0.003",
  "/api/v1/social/trending": "$0.002",
  ...
  // ---------------------------------------------------------------------------
  "/api/v1/anomalies": "$0.003",
  "/api/v1/entities": "$0.003",
  "/api/v1/claims": "$0.003",
  "/api/v1/correlations": "$0.005",
  "/api/v1/analytics/headlines": "$0.002",
  "/api/v1/analytics/credibility": "$0.002",
...
export const API_TIERS: Record<string, TierConfig> = {
  free: {
    id: "free",
    name: "Free (Discontinued)",
    price: 0,
    priceDisplay: "Discontinued",
    requestsPerDay: 0,
    requestsPerMinute: 0,
    rateLimit: "Discontinued",
    features: [
      "No longer issued",
      "Use /api/sample for a free preview",
      "Use x402 micropayment ($0.001/req) for pay-per-request access",
    ],
    permissions: [],
  },
  pro: {
...
Object.entries(API_TIERS).forEach(([tierName, config]) => {
  ...
  if (!Array.isArray(config.permissions)) {
    throw new Error(
      `FATAL: Tier '${tierName}' has invalid permissions (not an array).`,
    );
  }
  if (config.permissions.length === 0 && config.requestsPerDay > 0) {
    throw new Error(
      `FATAL: Tier '${tierName}' has empty permissions array but allows requests.`,
    );
  }
});
...
if (
  ...
  !globalThisAny.__tierConfigLogged
) {
...
export const ENDPOINT_METADATA: Record<string, EndpointMeta> = {
  "/api/v1/coins": {
    description:
      "List all cryptocurrencies with market data. Supports pagination and sorting.",
    parameters: {
      page: {
        type: "number",
  ...
  "/api/v1/historical": {
    ...
    parameters: {
      ...
      interval: {
        type: "string",
        description: "Data interval: hourly or daily",
        default: "daily",
      },
    },
  },
  ...
  "/api/v1/correlation": {
    description:
      "Correlation matrix showing price correlation between top cryptocurrencies.",
    parameters: {
      coins: {
        type: "string",
        description: "Comma-separated coin IDs (default: top 10)",
      },
      days: {
        type: "number",
...
export function getEndpointMetadata(endpoint: string): EndpointMeta {
  return (
    ENDPOINT_METADATA[endpoint] || { description: `API endpoint: ${endpoint}` }
  );
}
 ...
 */
export function getPremiumEndpointConfig(
  endpoint: string,
): PremiumEndpointConfig | null {
...
export function getPricingSummary() {
  ...
  return {
    ...
    priceRange: {
      ...
      avg:
        endpoints.reduce((sum, [, c]) => sum + c.price, 0) / endpoints.length,
    },
