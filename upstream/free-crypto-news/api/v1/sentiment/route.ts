 ...
 *
 * Premium API v1 - Market Sentiment Analysis Endpoint
 * Uses AI to analyze crypto news articles for market sentiment.
...
const ENDPOINT = '/api/v1/sentiment';
...
export async function GET(request: NextRequest): Promise<NextResponse> {
  ...
  try {
    logger.info('Fetching sentiment analysis', { limit, asset });
