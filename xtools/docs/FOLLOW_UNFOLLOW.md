...
from xtools.actions.base import RateLimiter, RateLimitConfig
...
```python
from xtools.actions.follow import FollowUser
...
```python
from xtools.actions.follow import FollowByKeyword
...
```python
from xtools.actions.follow import FollowByHashtag
...
```python
from xtools.actions.follow import FollowTargetFollowers
...
```python
from xtools.actions.follow import FollowEngagers
...
```python
from xtools.actions.follow import AutoFollow
...
```python
from xtools.actions.unfollow import UnfollowUser
...
```python
from xtools.actions.unfollow import UnfollowNonFollowers
...
```python
from xtools.actions.unfollow import SmartUnfollow
...
```python
from xtools.actions.unfollow import UnfollowAll
...
```python
from xtools.actions.unfollow import UnfollowByCriteria
...
tracker = FollowTracker('xtools_tracker.db')
...
```python
from xtools.actions.base import UnfollowFilters
...
xtools follow keyword python programming --max 50
xtools follow hashtag coding DevCommunity --max 30
xtools follow followers competitor_account --max 50
xtools follow engagers "https://x.com/user/status/123" --type likers

# Unfollow operations
xtools unfollow user someuser
xtools unfollow non-followers --max 100 --grace-days 3 --exclude-verified
xtools unfollow smart --days 3 --max 50
xtools unfollow all --max 100 --confirm

# Whitelist management
xtools whitelist add friend1 friend2 --reason "Friends"
xtools whitelist remove olduser
xtools whitelist list

# Statistics
xtools stats summary
xtools stats history username

# Export
xtools export history ./exports/history.csv
xtools export unfollowed ./exports/unfollowed.csv

# Common options
xtools --db custom.db follow user test  # Custom database
xtools -v unfollow non-followers  # Verbose output
```
...
```python
from xtools.actions.base import RateLimiter, RateLimitConfig, RateLimitStrategy
