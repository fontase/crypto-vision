...
from xtools.core.exceptions import ScrapingError, PaginationError
from xtools.core.utils import deduplicate_by_key, generate_filename
...
class BaseScraper(ABC):
    ...
    async def _extract_count(
        ...
        """
        from xtools.core.utils import parse_count
    ...
    def export(
        ...
        """
        from xtools.exporters import CSVExporter, JSONExporter, SQLiteExporter
