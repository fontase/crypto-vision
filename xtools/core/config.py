...
@dataclass
class Config:
    """Main configuration class for XTools."""
    ...
    def from_env(cls) -> "Config":
        ...
        # Auth from env
        config.username = os.getenv("XTOOLS_USERNAME")
        config.password = os.getenv("XTOOLS_PASSWORD")
        config.session_file = os.getenv("XTOOLS_SESSION_FILE")
        
        # Browser settings from env
        if os.getenv("XTOOLS_HEADLESS"):
            config.browser.headless = os.getenv("XTOOLS_HEADLESS", "true").lower() == "true"
        if os.getenv("XTOOLS_PROXY"):
            config.browser.proxy = os.getenv("XTOOLS_PROXY")
            
        # Logging from env
        config.log_level = os.getenv("XTOOLS_LOG_LEVEL", "INFO")
        config.log_file = os.getenv("XTOOLS_LOG_FILE")
