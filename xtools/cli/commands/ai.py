...
def get_ai_provider():
    ...
    from xtools.ai.providers import OpenAIProvider, AnthropicProvider, ProviderConfig
...
def ai():
    ...
    \b
    Examples:
        xtools ai reply "Great tweet about AI!"
        xtools ai generate "thread about Python tips" --num 5
