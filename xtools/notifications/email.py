...
class EmailConfig:
    ...
    use_tls: bool = True
    use_ssl: bool = False
    subject_prefix: str = "[XTools]"
    
    @classmethod
    def from_env(cls, prefix: str = "XTOOLS_EMAIL") -> "EmailConfig":
        """
...
class EmailNotifier:
    ...
    TEMPLATES = {
        "unfollower_detected": EmailTemplate(
            ...
            <hr>
            <p style="color: #666; font-size: 12px;">Sent by XTools Monitoring</p>
            </body>
            </html>
            """,
        ),
        ...
        "daily_report": EmailTemplate(
            ...
            {details_html}
            <hr>
            <p style="color: #666; font-size: 12px;">Sent by XTools Analytics</p>
            </body>
            </html>
            """,
        ),
        "default": EmailTemplate(
            ...
            <hr>
            <p style="color: #666; font-size: 12px;">Sent by XTools</p>
            </body>
            </html>
            """,
        ),
    ...
    async def send_report(
        ...
        <p style="color: #666; font-size: 12px;">
            Generated at {datetime.now().strftime('%Y-%m-%d %H:%M:%S')} by XTools
        </p>
        </body>
        </html>
        """
